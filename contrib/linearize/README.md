...
https://github.com/waggoxpay/waggox_hash
...
JSON-RPC server. Running `waggoxd` or `waggox-qt -server` will be sufficient.
...
* `input`: waggoxd blocks/ directory containing blkNNNNN.dat
