...
* Update translations, see [translation_process.md](https://github.com/waggoxpay/waggox/blob/master/doc/translation_process.md#synchronising-translations).

* Update manpages, see [gen-manpages.sh](https://github.com/waggoxpay/waggox/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
space *do not upload these to the waggox.org server*.
...
- Announce the release:
  ...
  - Optionally Discord, twitter, reddit /r/Waggoxpay, ... but this will usually sort out itself
  ...
  - Create a [new GitHub release](https://github.com/waggoxpay/waggox/releases/new) with a link to the archived release notes.
