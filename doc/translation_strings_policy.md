...
This document provides guidelines for internationalization of the Waggox Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `waggox_en.ts` remains unchanged.
