...
official/supported Docker Images found at https://hub.docker.com/r/waggoxpay/waggoxd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/waggoxpay/waggoxd-develop/ when changing the above text**