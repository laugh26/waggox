...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in waggox.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("waggox.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Waggox features */
    { "waggox",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "waggox",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "waggox",               "gobject",                &gobject,                true,  {} },
    { "waggox",               "voteraw",                &voteraw,                true,  {} },
