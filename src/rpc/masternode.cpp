...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Waggox address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "waggox",               "masternode",             &masternode,             true,  {} },
    { "waggox",               "masternodelist",         &masternodelist,         true,  {} },
    { "waggox",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "waggox",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "waggox",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "waggox",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
