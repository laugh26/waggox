...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    CService addr3 = ResolveService("250.3.2.2", 28288);
    CService addr4 = ResolveService("250.3.3.3", 28288);
    ...
    BOOST_CHECK(addrman.Select().ToString() == "250.3.2.2:28288");
    BOOST_CHECK(addrman.Select().ToString() == "250.3.3.3:28288");
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.2.1", 28288), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.251.2.2", 28288), NODE_NONE);
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket)
{
    ...
    CAddress addr2 = CAddress(ResolveService("250.1.1.1", 28288), NODE_NONE);
